                    ...
                    ws.packages.map((row) => (
                      <TableRow key={row.name}>
                        ...
                        <TableCell align="right">
                          <ListItem dense>
                            <Menu
                              label={<Tooltip title="Version Bump up">
	                              <IconButton
	                                aria-label="delete"
	                                size="medium"
	                              ...
	                              >
	                                <CgArrowUpO />
															...
															icon={false}
                              items={[
                                { label: "Patch", onClick: () => versionBump('patch', row.location) },
                                { label: "Minor", onClick: () => versionBump('minor', row.location) },
																{ label: "Major", onClick: () => versionBump('major', row.location) },
                              ]}
                            />
                          </ListItem>
                        </TableCell>
